...
//Adding Pictures to Webpage
let usanoxner_section = document.getElementById("image_holder");
for(let i = 0; i < 20; i++){
    usanoxner_section.innerHTML += "<div class='usanox_container'><img src='Images/10.jpg' width='100%' alt='Girl'></div>";
}
